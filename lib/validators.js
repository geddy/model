...
// Proxy validators with a scenario check
for(var key in validators) {
  (function (proxiedValidator) {
    validators[key] = function (name, val, params, rule, locale, scenario) {
      var validScenarios = rule.on
      ...
      if(shouldValidate) {
        return proxiedValidator(name, val, params, rule, locale);
      }
      else {
        return null;
      }
