...
utils.mixin(model, new (function () {
  ...
  this.createItem = function (name, p, o) {
    ...
    item = this.validateAndUpdateFromParams(item, params, opts, 'create');
  ...
  this.updateItem = function (item, params, opts) {
    ...
    this.validateAndUpdateFromParams(item, data, opts, 'update');
  ...
  this.validateAndUpdateFromParams = function (item, passedParams, opts, scenario) {
    var params
      , name = item.type
    ...
    for (var p in properties) {
      ...
      validated = this.validateProperty(properties[p], params, {}, scenario);
  ...
  this.validateProperty = function (prop, params, opts, scenario) {
    ...
    for (var p in validations) {
      ...
      err = validator(name, val, params, validations[p], locale, scenario);
