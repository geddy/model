  ...
  var _createModelItemConstructor = function (def) {
    ...
    var ModelItemConstructor = function (params) {
      ...
      var _saveAssociations = function (callback) {
        ...
        , _getThroughAssnKey = function (assn, assnType, modelType, opts) {
      ...
      this._getAssociation = function () {
        ...
        // (hasOne is just a special case of hasMany)
          ...
          if (through) {
            selfKeyName = _getThroughAssnKey(assn[assnName], assnType, this.type, {side: 'other'});
          }
          else {
        ...
        if (through) {
          ...
          model[through][queryName](query, opts, function (err, data) {
            ...
            idColName = _getThroughAssnKey(assn[assnName], assnType, modelName, {side: 'this'});
      ...
      this._createAssociation = function () {
        ...
        // hasOne, hasMany (through)
          ...
          if (through) {
            ...
            otherKeyName = _getThroughAssnKey(assn[assnName], assnType, this.type, {side: 'this'});
            selfKeyName = _getThroughAssnKey(assn[assnName], assnType, this.type, {side: 'other'});
