...
utils.mixin(model, new (function () {
  ...
  var _createModelItemConstructor = function (def) {
    ...
    var ModelItemConstructor = function (params) {
      ...
      /**
       * @name ModelBase#getProperties
       * @public
       * @function
       * @description Creates an object containing the set properties of an instance of a Geddy ModelBase object
       * @returns {Object} Returns an object containing all the set properties
       */
      this.getProperties = function () {
        return model.getItemProperties(this);
      };
      ...
      this.toJSON = function (options) {
        var self = this
          , opts = options || {}
          , whitelist = ['id', 'createdAt', 'updatedAt']
          , obj = {}
      ...
      this._getAssociation = function () {
        ...
        if (through) {
          ...
          model[through][queryName](query, opts, function (err, data) {
            ...
            idColName = association.getThroughAssnKey(assn[assnName], assnType, modelName, {side: 'this'});
      ...
      this._createAssociation = function () {
        ...
        // hasOne, hasMany (through)
          ...
          if (through) {
            ...
            otherKeyName = association.getThroughAssnKey(assn[assnName], assnType, this.type, {side: 'this'});
            selfKeyName = association.getThroughAssnKey(assn[assnName], assnType, this.type, {side: 'other'});
  ...
  this.getItemProperties = function (item) {
    var data = {}
      , properties = model.descriptionRegistry[item.type].properties;
    ...
    // 'id' doesn't seem to be part of the property list
    if ((data.hasOwnProperty('id') === false) && (item.hasOwnProperty('id') === true)) {
      data.id = item.id;
    }
