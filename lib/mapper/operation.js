...
create = function () {
  var type = arguments[0]
    , ctor = geddy.string.capitalize(type) + 'Operation';
    , inst;
...
OperationBase.prototype = new (function () {
  ...
  this.toString = function () {
    ...
    if (this.isEmpty()) {
      ...
      return '(' + ops.join(this.type.toUpperCase()) + ')';
    }
  };
...
, NotOperation: function () {
    ...
    this.toString = function () {
      return this.isEmpty() ? '' : 'NOT(' + this.operand() + ')';
    };
