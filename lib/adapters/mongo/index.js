...
// Progressive adapter enhancement
try {
...
utils.mixin(Adapter.prototype, new (function () {
  ...
  this.init = function () {
    var config = this.config
      , args = [];
    if (driver === undefined) {
      // Progressive enhancement failed, notify user
      console.warn('The MongoDB drivers are not installed.\nInstall them with `npm install mongodb mongodb-wrapper --save`');
      console.trace();
      process.exit(1);
    }
