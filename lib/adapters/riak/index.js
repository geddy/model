...
utils.mixin(Adapter.prototype, new (function () {
  ...
  this._serializeComparison = function (comp) {
    ...
    if (comp instanceof comparison.LikeComparison) {
      ret = this._serializeLikeComparison(comp);
    }
    else {
      ret = [this._serializeComparisonFieldName(comp),
  ...
  this._serializeLikeComparison = function (comp) {
    return this._serializeComparisonFieldName(comp) +
        '.indexOf(' + this._serializeComparisonValue(comp) +
        ') === 0';
  }
