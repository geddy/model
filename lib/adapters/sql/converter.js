...
module.exports = new (function () {
  ...
  this._tableizeModelName = function (name) {
    var pluralize = this.config
      && typeof this.config.pluralizeTableNames === "boolean"
      && this.config.pluralizeTableNames || true;

    return utils.string.getInflection(name, 'filename', pluralize ? 'plural' : 'singular');
  };
