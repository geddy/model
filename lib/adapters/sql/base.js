...
utils.mixin(Adapter.prototype, new (function () {
  ...
  this._createItemProcessor = function (query, callback) {
    var self = this;

    return function (err, rows) {
      var meta = query._sqlMetadata
...
EventedItemProcessor = function (query, callback) {
  this._source = null;
  this._allItems = [];
  this._itemBuffer = [];
...
util.inherits(EventedItemProcessor, EventEmitter);

utils.mixin(EventedItemProcessor.prototype, new (function () {
...
Adapter.EventedItemProcessor = EventedItemProcessor;
