  ...
  this._createSelectStatementWithConditions = function (query) {
    ...
    */
    ...
    if (query.opts.count) {
      ...
      sql += 'DISTINCT ' + this.COLUMN_NAME_DELIMITER + meta.mainTable + this.COLUMN_NAME_DELIMITER +
              '.' + this.COLUMN_NAME_DELIMITER + 'id' + this.COLUMN_NAME_DELIMITER +
              ' ' + this.COLUMN_NAME_DELIMITER + meta.mainKey + '#' + 'id' + this.COLUMN_NAME_DELIMITER;
        ...
        sql += ', ' + this.transformSortOrder(sort, meta)
            ...
            .map(function (columnField) {
                ...
                return columnField + ' ' + self.COLUMN_NAME_DELIMITER +
                        columnField.replace(new RegExp(meta.mainTable + '\\."'), meta.mainKey + '#')
              })
            .join(', ')
      }
    }
