            ...
            rows.forEach(function (row) {
              ...
              tables.forEach(function (p) {
                ...
                // Association table-name
                  ...
                  // Ignore empty records and items already created
                  if (params.id && !instantiatedObjects[p][params.id]) {
                    ...
                    if (modelItem.assnType == 'hasMany') {
                      inst[p] = inst[p] || [];
                      inst[p].push(assnInst);
                    }
                    else {
                      inst[utils.string.getInflection(p, 'property', 'singular')] = assnInst;
                    }
                  }
                }
              });
